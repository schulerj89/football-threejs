...
- Every production player uses the original modular helmet at all camera distances; no generated helmet LOD or proxy is substituted during gameplay.
- The editable voxel-player Blender source and deterministic generator live under `art-source/blender/voxel-player` and `tools/blender/create_voxel_player.py`.
