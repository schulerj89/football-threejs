...
- Use `?playbook=7v7` to explicitly launch the default 7v7 playbook, or use `?playbook=5v5` / `5v5 Legacy Development Mode` to run the preserved five-on-five regression drill with Inside Run, Outside Run, Quick Pass, and Slant Flat.
