...
- The broadcast experience preset is the default normal-game profile: 11v11 playbook, offense camera, brief cinematics, mathematical stadium enabled, presentation-only officials enabled, low-density crowd visuals, crowd reactions, runtime audio, crowd audio, announcer enabled, captions disabled, route art enabled, player motion enabled, and Adaptive 60 FPS quality mode.
- The performance preset keeps the offense camera, mathematical stadium, and player motion while disabling expensive visual presentation: cinematics, visual crowd, crowd reactions, and officials. Performance may simplify stadium presentation by disabling upper-tier geometry and image materials.
