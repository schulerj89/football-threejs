...
- The broadcast experience preset is the default normal-game profile: 11v11 playbook, offense camera, brief cinematics, low-density crowd visuals, crowd reactions, runtime audio, crowd audio, announcer enabled, captions disabled, route art enabled, player motion enabled, and Adaptive 60 FPS quality mode.
