...
- The broadcast experience preset is the default normal-game profile: 11v11 playbook, offense camera, brief cinematics, mathematical stadium enabled, low-density crowd visuals, crowd reactions, runtime audio, crowd audio, announcer enabled, captions disabled, route art enabled, player motion enabled, and Adaptive 60 FPS quality mode.
- The performance preset keeps the offense camera, mathematical stadium, and player motion while disabling expensive visual presentation: cinematics, visual crowd, and crowd reactions. Performance may simplify stadium presentation by disabling upper-tier geometry and image materials.
...
- Plain launch, broadcast settings, and the setup flow select the 11v11 prototype by default.
- The 11v11 playbook exposes Inside Zone 11 and Spread Quick 11 with play cards generated from real formation, blocking, protection, coverage, and route data.
- Spread Quick 11 creates twenty-two active players, five ordered eligible receivers, unique pass-protection assignments, valid coverage assignments, deep safety help, deterministic route starts, catch/control transfer, incompletion spotting, and sack/post-release contact behavior.
- `?playbook=7v7` and `?playbook=5v5` remain explicit regression paths.
- README, AGENTS, package version, and CHANGELOG reflect the 11v11 default promotion.
- Existing 11v11, 7v7, 5v5, build, unit, and browser smoke tests pass.
