...
export const MENU_MUSIC_TRACKS: readonly MenuMusicTrack[] = [
  ...
  },
  {
    ...
    durationSeconds: 80.04,
    energyLevel: 'high',
    looping: true,
    runtimeAudioUrl: '/audio/music/football-js-campus-kickoff.mp3',
    transitionPurpose: 'menu-playlist',
  },
  {
    ...
    energyLevel: 'peak',
    looping: true,
    runtimeAudioUrl: '/audio/music/football-js-marching-drive.mp3',
    transitionPurpose: 'menu-playlist',
  },
  {
    ...
    durationSeconds: 76.032,
    energyLevel: 'high',
    looping: true,
    runtimeAudioUrl: '/audio/music/football-js-victory-march.mp3',
    transitionPurpose: 'menu-playlist',
  },
  {
    ...
    energyLevel: 'high',
    looping: true,
    runtimeAudioUrl: '/audio/music/football-js-sideline-sparks.mp3',
    transitionPurpose: 'menu-playlist',
  },
  {
    ...
    energyLevel: 'peak',
    looping: true,
    runtimeAudioUrl: '/audio/music/football-js-fourth-quarter-lights.mp3',
    transitionPurpose: 'menu-playlist',
  },
] as const;
