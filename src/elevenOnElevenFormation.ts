...
export function createElevenOnElevenPreviewFormation(
  ...
  return {
    formation: [
      ...
      defenseSlot('defense-line-left', 'defender', point(snap(-ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineEdgeGap), defenseDepth(ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineDepth))),
      defenseSlot('defense-line-middle', 'defender', point(snap(-ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineInteriorGap), defenseDepth(ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineDepth))),
      defenseSlot('defense-linebacker-inside', 'defender', point(snap(ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineInteriorGap), defenseDepth(ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineDepth))),
      defenseSlot('defense-line-right', 'defender', point(snap(ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineEdgeGap), defenseDepth(ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineDepth))),
    ...
    validation: {
      ...
      defensiveGapOffsets: {
        'defense-line-left': -ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineEdgeGap,
        'defense-line-middle': -ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineInteriorGap,
        'defense-linebacker-inside': ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineInteriorGap,
        'defense-line-right': ELEVEN_ON_ELEVEN_FORMATION_MEASUREMENTS.defensiveLineEdgeGap,
      },
