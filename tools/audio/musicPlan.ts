...
export const FOOTBALL_MENU_PLAYLIST_PLAN: readonly AudioAssetPlan[] = [
  ...
  {
    assetId: 'football-js-campus-kickoff',
    category: 'music',
    generationStatus: 'planned',
    kind: 'music',
    loop: true,
    ...
    metadata: {
      catalogCategory: 'menu',
      composerDisplay: FOOTBALL_MUSIC_COMPOSER_DISPLAY,
      displayTitle: 'Campus Kickoff',
      energyLevel: 'high',
      transitionPurpose: 'menu-playlist',
    },
    modelId: FOOTBALL_TITLE_MUSIC_MODEL_ID,
    notes: 'Menu playlist track: college-game-day brass and cadence energy.',
    outputFormat: FOOTBALL_TITLE_MUSIC_OUTPUT_FORMAT,
    outputPath: 'public/audio/music/football-js-campus-kickoff.mp3',
    prompt: [
      MENU_TRACK_DIRECTION,
      'Track identity: Campus Kickoff. Original college-football game-day energy, bright brass section, marching snare cadence, bass drum hits, cymbal lifts, clean pep-band-inspired momentum without copying any real fight song, approximately 80 seconds.',
    ].join(' '),
    requestedDurationSeconds: 80,
    runtimeLoadingStrategy: 'stream',
  },
  {
    assetId: 'football-js-marching-drive',
    category: 'music',
    generationStatus: 'planned',
    kind: 'music',
    loop: true,
    ...
    metadata: {
      catalogCategory: 'menu',
      composerDisplay: FOOTBALL_MUSIC_COMPOSER_DISPLAY,
      displayTitle: 'Marching Drive',
      energyLevel: 'peak',
      transitionPurpose: 'menu-playlist',
    },
    modelId: FOOTBALL_TITLE_MUSIC_MODEL_ID,
    notes: 'Menu playlist track: high-energy marching percussion and brass.',
    outputFormat: FOOTBALL_TITLE_MUSIC_OUTPUT_FORMAT,
    outputPath: 'public/audio/music/football-js-marching-drive.mp3',
    prompt: [
      MENU_TRACK_DIRECTION,
      'Track identity: Marching Drive. Up-tempo college stadium instrumental, drumline groove, snare rolls, tenor tom fills, bold original horn motif, low brass support, energetic but polished game-menu mix, approximately 84 seconds.',
    ].join(' '),
    requestedDurationSeconds: 84,
    runtimeLoadingStrategy: 'stream',
  },
  {
    assetId: 'football-js-victory-march',
    category: 'music',
    generationStatus: 'planned',
    kind: 'music',
    loop: true,
    ...
    metadata: {
      catalogCategory: 'menu',
      composerDisplay: FOOTBALL_MUSIC_COMPOSER_DISPLAY,
      displayTitle: 'Victory March',
      energyLevel: 'high',
      transitionPurpose: 'menu-playlist',
    },
    modelId: FOOTBALL_TITLE_MUSIC_MODEL_ID,
    notes: 'Menu playlist track: original ceremonial college marching-band sports theme.',
    outputFormat: FOOTBALL_TITLE_MUSIC_OUTPUT_FORMAT,
    outputPath: 'public/audio/music/football-js-victory-march.mp3',
    prompt: [
      MENU_TRACK_DIRECTION,
      'Track identity: Victory March. Ceremonial college-style sports instrumental, confident original brass melody, steady marching percussion, handoff-ready loop ending, heroic but not bombastic, no real school or fight-song reference, approximately 76 seconds.',
    ].join(' '),
    requestedDurationSeconds: 76,
    runtimeLoadingStrategy: 'stream',
  },
  {
    assetId: 'football-js-sideline-sparks',
    category: 'music',
    generationStatus: 'planned',
    kind: 'music',
    loop: true,
    ...
    metadata: {
      catalogCategory: 'menu',
      composerDisplay: FOOTBALL_MUSIC_COMPOSER_DISPLAY,
      displayTitle: 'Sideline Sparks',
      energyLevel: 'high',
      transitionPurpose: 'menu-playlist',
    },
    modelId: FOOTBALL_TITLE_MUSIC_MODEL_ID,
    notes: 'Menu playlist track: safe pop-punk/indie rock energy without artist imitation.',
    outputFormat: FOOTBALL_TITLE_MUSIC_OUTPUT_FORMAT,
    outputPath: 'public/audio/music/football-js-sideline-sparks.mp3',
    prompt: [
      'Create original instrumental menu music for Football JS, a stylized low-poly American-football video game.',
      'Use upbeat pop-punk and indie-rock sports-menu energy: bright rhythm guitars, tight live drums, driving bass, hooky original lead melody, clean power-chord motion, occasional melodic string-like lead color, and a polished optimistic game-menu mix.',
      'Blend the rock band with subtle stadium percussion accents so it still belongs in the Football JS soundtrack.',
      'Design the ending so it can loop or transition cleanly back to the opening.',
      'No vocals, no spoken words, no artist references, no band references, no song-title references, no copyrighted motifs, no real fight-song melodies, no real team references, no crowd chants, no announcers, no excessive distortion.',
      'Track identity: Sideline Sparks. Energetic, bright, youthful, competitive, approximately 78 seconds.',
    ].join(' '),
    requestedDurationSeconds: 78,
    runtimeLoadingStrategy: 'stream',
  },
  {
    assetId: 'football-js-fourth-quarter-lights',
    category: 'music',
    generationStatus: 'planned',
    kind: 'music',
    loop: true,
    ...
    metadata: {
      catalogCategory: 'menu',
      composerDisplay: FOOTBALL_MUSIC_COMPOSER_DISPLAY,
      displayTitle: 'Fourth Quarter Lights',
      energyLevel: 'peak',
      transitionPurpose: 'menu-playlist',
    },
    modelId: FOOTBALL_TITLE_MUSIC_MODEL_ID,
    notes: 'Menu playlist track: safe high-energy indie rock/pop-punk sports anthem.',
    outputFormat: FOOTBALL_TITLE_MUSIC_OUTPUT_FORMAT,
    outputPath: 'public/audio/music/football-js-fourth-quarter-lights.mp3',
    prompt: [
      'Create original instrumental menu music for Football JS, a stylized low-poly American-football video game.',
      'Use high-energy indie rock and pop-punk sports-anthem ingredients: fast clean drums, punchy bass, layered bright guitars, open-chord lift, memorable original lead hook, controlled melodic string-like accent, and a polished arcade-football menu mix.',
      'Keep it energetic and emotional without imitating any specific band, artist, or existing song.',
      'Design the ending so it can loop or transition cleanly back to the opening.',
      'No vocals, no spoken words, no artist references, no band references, no song-title references, no copyrighted motifs, no real team references, no real fight-song melodies, no crowd chants, no announcers.',
      'Track identity: Fourth Quarter Lights. Fast, hopeful, competitive, stadium-ready, approximately 82 seconds.',
    ].join(' '),
    requestedDurationSeconds: 82,
    runtimeLoadingStrategy: 'stream',
  },
